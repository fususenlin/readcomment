    ...
    $.fn.jPaginator = function(o) {
        ...
        return this.each(function() {
            ...
            function updateNum(newNum) {
                ...
                $this.find(".paginator_p_bloc").css("left", "0");
            ...
            function init() {
                ...
                $this.find(".paginator_p").css("width", "auto");
                $this.find(".paginator_p").css("margin", "0 " + s.marginPx + "px 0 " + "2px");

                $this.find(".paginator_p_wrap").css("width", "70%");
                $this.find(".paginator_slider").css("width", "100%");
